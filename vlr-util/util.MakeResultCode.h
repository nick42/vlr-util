...
inline constexpr auto MakeResultCode(unsigned char nSeverityCode, unsigned short nFacilityCode, unsigned short nResultCode) noexcept
{
...
inline constexpr auto MakeResultCode_Success(unsigned short nFacilityCode, unsigned short nResultCode) noexcept
{
	return MakeResultCode(Severity_Success, nFacilityCode, nResultCode);
}
inline constexpr auto MakeResultCode_Failure(unsigned short nFacilityCode, unsigned short nResultCode) noexcept
{
	return MakeResultCode(Severity_Failure, nFacilityCode, nResultCode);
}

inline constexpr auto MakeResultCode_Failure_CallSpecific(unsigned short nResultCode) noexcept
{
...
inline constexpr auto MakeResultCode_Failure_CallSpecific(TCode nResultCodeLong) noexcept
{
	auto nResultCode = vlr::util::range_checked_cast<unsigned short>(nResultCodeLong);
	return MakeResultCode(Severity_Failure, Facility_CallSpecific, nResultCode);
}
inline constexpr auto MakeResultCode_Failure_Win32(unsigned short nResultCode) noexcept
{
	return MakeResultCode(Severity_Failure, Facility_Win32, nResultCode);
}
template <typename TCode, typename std::enable_if_t<std::is_integral_v<TCode>>* = nullptr>
inline constexpr auto MakeResultCode_Failure_Win32(TCode nResultCodeLong) noexcept
{
	auto nResultCode = vlr::util::range_checked_cast<unsigned short>(nResultCodeLong);
	return MakeResultCode(Severity_Failure, Facility_Win32, nResultCode);
}
